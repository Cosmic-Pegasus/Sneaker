                ...
                <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
                    <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                        ...
                        <nav className="list-none mb-10">
                            <li>
                                <a className="text-gray-400 hover:text-white">Nike</a>
                            </li>
                            <li>
                                <a className="text-gray-400 hover:text-white">Adidas</a>
                            </li>
                            <li>
                                <a className="text-gray-400 hover:text-white">Jordan</a>
                            </li>
                            <li>
                                <a className="text-gray-400 hover:text-white">Converse</a>
                            </li>
                        </nav>
                    </div>
                    ...
                    <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                        ...
                        <nav className="list-none mb-10">
                            <li>
                                <a className="text-gray-400 hover:text-white">Hot Drops</a>
                            </li>
                            <li>
                                <a className="text-gray-400 hover:text-white">New Arrivals</a>
                            </li>
                            <li>
                                <a className="text-gray-400 hover:text-white">Popular</a>
                            </li>
                            <li>
                    ...
                    <div class="lg:w-1/4 md:w-1/2 w-full px-4" id='input-email'>
                        ...
                        <div class="flex xl:flex-nowrap md:flex-nowrap lg:flex-wrap flex-wrap justify-center items-end md:justify-start">
                            ...
                            <button class="lg:mt-2 xl:mt-0 flex-shrink-0 inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded" style={{backgroundColor:"rgb(53, 42, 54)"}}>Subscribe</button>
                        </div>
                        <p class="text-gray-500 text-sm mt-2 md:text-left text-center">Subscribe to get latest updates
                            <br class="lg:block hidden" /> from our side
                        </p>
                    </div>
                </div>
            </div>
